        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            ...
            <div class="flex justify-center px-0 mt-16 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    Laravel v<?php echo e(Illuminate\Foundation\Application::VERSION); ?> (PHP v<?php echo e(PHP_VERSION); ?>) & Livewire
                    <?php echo e(\Composer\InstalledVersions::getPrettyVersion('livewire/livewire')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toll_app\resources\views/welcome.blade.php ENDPATH**/ ?>